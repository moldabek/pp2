...
{
    public partial class Калькулатор : Form
    {
        Calc calc = new Calc();
        ...
        private void Mono_operattions(object sender, EventArgs e)
        {
            Button b = sender as Button;
        ...
        private void Bi_(object sender, EventArgs e)
        {
        ...
        private void ChS(object sender, EventArgs e)
        {
